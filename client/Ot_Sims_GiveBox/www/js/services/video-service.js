'use strict';
angular.module('starter.services.Video', [])
...
.service('VideoService', function($q) {
	...
	function prevImageSuccess(succ) {
		...
		currentDeffered.resolve(correctUrl);
	}
	...
	return {
		...
		saveVideo: function(data, scope) {
			...
			currentDeffered = $q.defer();
			var promise = currentDeffered.promise;
